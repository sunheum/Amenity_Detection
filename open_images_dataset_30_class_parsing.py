...
flags.DEFINE_string('class_file_path',
                    default='/Users/shpark/Documents/workspace/class-descriptions-boxable.csv',
                    help='class-descriptions-boxable.csv file path')
flags.DEFINE_string('annotaton_file_path',
                    default='/Users/shpark/Documents/workspace/validation-annotations-bbox.csv',
                    help='validation-annotations-bbox.csv file path')
flags.DEFINE_string('image_folder_path',
                    default='/Users/shpark/Documents/workspace/validation',
                    help='image folder path')
flags.DEFINE_string('filtered_image_folder_path',
                    default='/Users/shpark/Documents/workspace/filtered_validation_images',
...
def main(_):
  ...
  make_directory(FLAGS.filtered_image_folder_path + os.sep + 'aggregated')  # Total 30 class images
  ...
  for index, row in annotation_df.iterrows():
    if row['LabelName'] in target_class_id_dict.values():
      copyfile(FLAGS.image_folder_path + os.sep + row['ImageID'] + '.jpg', FLAGS.filtered_image_folder_path + os.sep + 'aggregated' + os.sep + row['ImageID'] + '.jpg')
      copyfile(FLAGS.image_folder_path + os.sep + row['ImageID'] + '.jpg', FLAGS.filtered_image_folder_path + os.sep + target_id_class_dict[row['LabelName']] + os.sep + row['ImageID'] + '.jpg')
