...
flags.DEFINE_string('data_dir',
                    '/Users/shpark/Documents/AI_포트폴리오/filtered_train_images/aggregated',
                    'Root directory to raw open image dataset.')
flags.DEFINE_string('output_dir', '', 'Path to directory to output TFRecords.')
flags.DEFINE_string('label_map_path',
                    '/Users/shpark/Documents/AI_포트폴리오/oid_v4_label_map_amenity_30_class.pbtxt',
                    'Path to label map proto')
flags.DEFINE_string('class_file_path',
                    '/Users/shpark/Documents/AI_포트폴리오/class-descriptions-boxable.csv',
                    'class-descriptions-boxable.csv file path')
flags.DEFINE_string('annotation_file_path',
                    '/Users/shpark/Documents/AI_포트폴리오/train-annotations-bbox.csv',
